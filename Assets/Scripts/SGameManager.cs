...
public class SGameManager : Singleton<SGameManager> {
	...
	public static void increment_letters_active(){
		++Instance.letters_active;
	}

	public static void decrement_letters_active(){
		if (--Instance.letters_active <= 0) {
			Instance.startOpenBook();
		}
	}

	public static void endLevel(){
		Instance.startCloseBook ();
	}
